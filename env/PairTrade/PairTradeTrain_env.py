...
class PairEnvTrade(Env):
    ...
    def __init__(
        ...
        obs_shape = 3 + self.stock_dim * self.config.OBSERVATIONS + (
                    self.time_window * 2 * (self.stock_dim + 2))  # + (self.index_dim * self.config.INDEX_OBSERVATIONS)
